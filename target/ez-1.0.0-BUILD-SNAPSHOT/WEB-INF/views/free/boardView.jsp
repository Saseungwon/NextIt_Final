...
#id_re_str{
 ...
 -->
 <body>
			<c:if test="${board.boDelYn eq 'N' || sessionScope.MEM_INFO.memRole eq 'MANAGER'}">
	<div class="container">
		...
		<table class="table table-striped table-bordered">
			<tbody>
				...
				<tr>
					<th>내용</th>
					<td><textarea rows="10" name="boContent" class="form-control input-sm" readonly="readonly">${board.boContent }</textarea></td>
				</tr>
				<tr>
					<th>조회수</th>
					<td>${board.boHit }</td>
