...
public class AttachUtils {
	...
	public AttachVO getAttachByMultipart(MultipartFile multipart, String path) throws IOException {
		if (!multipart.isEmpty()) {
			...
			vo.setAtchPath(path + new SimpleDateFormat("yyyy/MM").format(new Date()));
			vo.setAtchFancySize(AttachFileUtils.fancySize(multipart.getSize()));
	...
	public List<AttachVO> getAttachListByMultiparts(MultipartFile[] multipartFiles, String path)
			throws IOException {
